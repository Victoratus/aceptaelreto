...
void insert_list(List *list, short id) {
...
void remove_list(List *list, short id) {
...
short is_in_list(List_node *list_node, short id) {
...
void add_connection(Node *node1, Node *node2) {
    node1->num_adj++;
    node2->num_adj++;
    node1->adj = (short *) realloc(node1->adj, node1->num_adj*sizeof(short));
    node2->adj = (short *) realloc(node2->adj, node2->num_adj*sizeof(short));
...
short number_of_nodes(Graph *graph, List *list) {
    short i;
    short size = 1;
    short id = list->first->id;
    std::stack <short> s;
    s.push(id);
    remove_list(list, id);
